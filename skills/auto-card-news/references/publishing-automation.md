...
- Instagram default: publish both the card-news carousel and the Reel when both assets exist.
- Threads upload should use the official Threads API publishing flow.
- Threads default: publish only the card-news image set/carousel, then add source/GitHub/docs links in the first reply/comment.
